...
VERSION_HEADER = bytearray('MesaScreenBorderControlVersion', 'utf-8')
DEVICE_NAME_HEADER = bytearray('DeviceName', 'utf-8')
MESA_VERSION_HEADER = bytearray('MesaVersion', 'utf-8')

DEFAULT_SERVER_ADDRESS = "\0mesa_screen_border_overlay"
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='MESA_screen_border control client')
